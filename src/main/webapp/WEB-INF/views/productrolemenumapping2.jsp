...
<%@ include file="includes/sidebar-menu2.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
          <h1>
           Select Menu to Map to ${roleName} Specification
           
          </h1>
          <small>(Checked Columns of Menu are already mapped to role)</small>
      </section>
          ...
          <c:forEach items="${ProductRoleMenuCheckBoxList}" var="item" varStatus="status"  > 
            ...
            <form:form method="POST" modelAttribute="productRoleMenuForm" class="form-signin">
              <!--<h2 class="form-signin-heading"> Product Name</h2>-->
                ...
                <h3 class="box-title"> <b> <c:out value="${item.productName}"/> </b>  </h3>
               <!--<p> <c:out value="${productNameArray[status.getIndex()]}"/>   </p>-->
                 </div>
               
                <div>Menu list already assigned To Role</div>
                 <p> &nbsp; </p>
               ...
               <c:choose>
                  ...
                  <form:checkboxes items="${item.menuListCheckBox}" path="menuListCheckBox" class="flat-red"
            ...
            <p>Menu list for <c:out value="${item.productName}"/> </p> 
             ...
             <p> &nbsp; </p>
                 ...
                 <c:choose>
                   ...
                   <div class="form-group ${status.error ? 'has-error' : ''}">
                  <form:checkboxes items="${item.allMenuListCheckBox}" path="allMenuListCheckBox" class="flat-red"
                          />
                             <br />
                             </div>

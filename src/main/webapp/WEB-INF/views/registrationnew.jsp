...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <spring:bind path="userSelected">
            
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <div class="col-sm-10">
          <form:select id="userSelected" name="userSelected" path="userSelected" class="form-control"
            ...
            <c:forEach var="roleLists" items="${roleList}">
                ...
                <option value="${roleLists}">${roleLists}</option>

            </c:forEach>

                     </form:select>
               
                <form:errors path="userSelected"></form:errors>
            </div>
            </div>
        </spring:bind>
